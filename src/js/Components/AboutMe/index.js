...
const AboutMe = () => {
  const aboutMeJsx = () => (
    <div className="about-me">
      ...
      />
      <p>
        I'm a dev that sleeps in Brooklyn. I believe that by learning something
        new, today, we promise ourselves a better tomorrow. While I work as a
        full-time software engineer and coach at Flatiron School x WeWork, I'm
        completing my B.S. in Computer Science part-time.
      </p>
      <p>
