  ...
  return (
    <div className="connect-page">
      ...
      <div className="social-media">
        ...
        <a
          href="https://github.com/Lexscher"
          target="_blank"
          className="social-media-item"
          id="github-svg"
        >
        ...
        <a
          href="https://twitter.com/Lexscher"
          target="_blank"
          className="social-media-item"
          id="twitter-svg"
        >
        ...
        <a
          href="https://medium.com/@lexscher"
          target="_blank"
          className="social-media-item"
          id="medium-svg"
        >
        ...
        <a
          href="https://drive.google.com/file/d/1NGEpQqUyIGlztN_euKAvxyJgMEtZ2Oor/view"
          target="_blank"
          className="social-media-item"
          id="resume-svg"
        >
